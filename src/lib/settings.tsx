...
const pt: Dict = {
  ...
  modeMap: "Mapa",
  modeFlag: "Bandeiras",
  whichFlag: "De que país é esta bandeira?",
  typeAnswer: "Digite o nome do país",
  typeMsg: "Digite o nome do país e confirme.",
  flagWrong: "Errou. Era {name}.",
  skip: "Pular",
  next: "Próximo país",
  check: "Checar",
  ...
  useCodeNoPassword: "Entrar com código (sem senha)",
  rooms: "Salas",
  ffaMode: "Todos contra todos",
  duel1v1: "Duelo 1x1",
  loadingMatch: "Carregando partida...",
  time: "Tempo",
  yourHits: "Seus acertos",
  waitingPlayers: "Esperando jogadores…",
...
const en: Dict = {
  ...
  modeMap: "Map",
  modeFlag: "Flags",
  whichFlag: "Which country owns this flag?",
  typeAnswer: "Type the country name",
  typeMsg: "Type the country name and confirm.",
  flagWrong: "Wrong. It was {name}.",
  skip: "Skip",
  next: "Next country",
  check: "Check",
  ...
  useCodeNoPassword: "Sign in with a code (no password)",
  rooms: "Rooms",
  ...
  couldNotStart: "Could not start the match.",
  couldNotSend: "Could not send your guess.",
  matchEnd: "Match over",
  draw: "Draw!",
  youWon: "You won!",
...
const es: Dict = {
  ...
  modeMap: "Mapa",
  modeFlag: "Banderas",
  whichFlag: "¿De qué país es esta bandera?",
  typeAnswer: "Escribe el nombre del país",
  typeMsg: "Escribe el nombre del país y confirma.",
  flagWrong: "Fallaste. Era {name}.",
  skip: "Saltar",
  next: "Siguiente país",
  check: "Comprobar",
  ...
  useCodeNoPassword: "Entrar con código (sin contraseña)",
  rooms: "Salas",
  ffaMode: "Todos contra todos",
  duel1v1: "Duelo 1x1",
  loadingMatch: "Cargando partida...",
  time: "Tiempo",
  yourHits: "Tus aciertos",
...
const fr: Dict = {
  ...
  modeMap: "Carte",
  modeFlag: "Drapeaux",
  whichFlag: "À quel pays appartient ce drapeau ?",
  typeAnswer: "Écris le nom du pays",
  typeMsg: "Écris le nom du pays puis valide.",
  flagWrong: "Raté. C'était {name}.",
  skip: "Passer",
  next: "Pays suivant",
  check: "Valider",
  ...
  useCodeNoPassword: "Se connecter avec un code (sans mot de passe)",
  rooms: "Salles",
  ffaMode: "Chacun pour soi",
  duel1v1: "Duel 1c1",
  loadingMatch: "Chargement de la partie...",
  time: "Temps",
  yourHits: "Tes bonnes réponses",
  waitingPlayers: "En attente de joueurs…",
  roomCode: "Code de la salle :",
  player: "Joueur",
  startNow: "Commencer",
  leaveRoom: "Quitter la salle",
  couldNotStart: "Impossible de commencer.",
  couldNotSend: "Impossible d'envoyer.",
  matchEnd: "Fin de la partie",
  draw: "Égalité !",
  youWon: "Tu as gagné !",
